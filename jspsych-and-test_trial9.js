...
jsPsych.plugins['and-test_trial9'] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('and-test_trial9', ['images'], 'image');
  jsPsych.pluginAPI.registerPreload('and-test_trial9', 'audio', 'audio');
  jsPsych.pluginAPI.registerPreload('and-test_trial9', 'audioTrill', 'audio');
  ...
  plugin.trial = function(display_element, trial) {
   ...
   display_element.append($("<svg id='jspsych-and-test_trial9-canvas' width=" + trial.canvas_size[0] + " height=" + trial.canvas_size[1] + "></svg>"));

    var s = Snap("#jspsych-and-test_trial9-canvas");
